...
<div class="row post-item list-item" data-tag='{{$jobType}}'>

	<div class="col-md-12 home-post">

		<div class="timeline" >
			<!-- TIMELINE ITEM -->
			<div class="timeline-item time-item-ex" itemscope itejtype="http://schema.org/Article" style="padding: 3px 6px;">
				...
				<div class="post-hover-act" data-postid="{{$post->id}}" style="border-top: 1px solid #e9edef;">
						...
						<div class="row" style="">
							...
							@if($match == 'GoodMatch')
								...
								<div class="col-md-5 col-sm-5 col-xs-5">
									...
									<i class="icon-speedometer magic-font" style="font-size:10px;"></i> &nbsp;Quick View</div>
									</a>
								</div>
								@endif
							@elseif($postType == 'skill')
							<div class="col-md-5 col-sm-5 col-xs-5" style="margin: 4px 0px;">
							...
							@endif
							<!-- <div class="col-md-3 col-sm-3 col-xs-5" style="line-height: 1.9;">
