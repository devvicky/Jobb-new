...
<!-- BEGIN LOGIN -->
<div class="content" style="background-color: rgba(255,255,255,.15) !important;">

	<!-- BEGIN LOGIN FORM -->
	<form class="login-form"  action="{{ url('/auth/login') }}" method="post" id="individual-login">
		<div class="form-body">
			<h3 class="form-title" style="text-shadow: 0px 1px 1px blue;color: khaki;font-size: 20px;margin-bottom: 15px;">Login As</h3>
				<div class="row" style="margin-bottom: 25px;">
					<div class="col-md-2 col-sm-2 col-xs-1"></div>
					<div class="col-md-10 col-sm-10 col-xs-10">
						<div class="btn-group input-group" data-toggle="buttons" style="box-shadow:0 2px 3px;">
							<label class="" id="loginindividual" style="margin-bottom:0;">
								<button class="btn btn-default active button-responsive" type="button" style="border-radius: 2px 0px 0px 2px;color: white;background-color: #45B69C;border:0;">
									<i class="fa fa-user" style="border-radius: 10px 0px 0px 10px;color: white;"></i>&nbsp;Individual
								</button>
							 </label>
							 <label class="" id="logincorporate" style="margin-bottom:0;">
							 	<button class="btn btn-default button-responsive" type="button" style="border-left:0;border-radius: 0px 2px 2px 0px;color: #CACCC9;background-color: #577C8C;border:0;">
									<i class="fa fa-university" style="color: #CACCC9;"></i>&nbsp;Corporate
								</button>
							 </label>
						</div>
					</div>
				...
				<h2 class="decorated" style="margin: 0px 10px 8px 10px;color: #D0D0D0;">
				...
				<div class="login-options" >
					<div class="row social">
						<div class="col-md-2 col-sm-3 col-xs-3 " style="padding-right:2px;margin:5px 0;">
							<a class="btn btn-lg btn-facebook btn-block" href="{!!URL::to('facebook')!!}" style="background: rgb(51, 69, 107);color: white;border-radius:0px;">
								<i class="fa fa-facebook "></i>
							</a>
						</div>
						<div class="col-md-10 col-sm-9 col-xs-9 " style="padding:0px;margin:5px -2px;">
							<a class="btn btn-lg btn-facebook btn-block" href="{!!URL::to('facebook')!!}" style="background: #3b5998;color: white;border-radius:0px;padding:15px;">
								<span style="font-size:13px;">Login with Facebook</span>
							</a>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-3" style="padding-right:2px;margin:5px 0px;">
							<a class="btn btn-lg btn-google btn-block" href="{!!URL::to('google')!!}" style="background: #90220B;color: white;border-radius:0px;">
								<i class="fa fa-google-plus"></i>
							</a>
						</div>
						<div class="col-md-10 col-sm-9 col-xs-9" style="padding:0px;margin:5px -2px;">
							<a class="btn btn-lg btn-google btn-block" href="{!!URL::to('google')!!}" style="background: #c32f10;color: white;border-radius:0px;padding:15px;">
								<span style="font-size:13px;">Login with Google+</span>
							</a>
						</div>
						<div class="col-md-2 col-sm-3 col-xs-3" style="padding-right:2px;margin:5px 0;">
							<a class="btn btn-lg btn-linkedin btn-block" href="{!!URL::to('linkedin')!!}" style="background: #136888;color: white;border-radius:0px;">
								<i class="fa fa fa-linkedin"></i>
							</a>
						</div>
						<div class="col-md-10 col-sm-9 col-xs-9" style="padding:0px;margin:5px -2px;">
							<a class="btn btn-lg btn-linkedin btn-block" href="{!!URL::to('linkedin')!!}" style="background: #00aced;color: white;border-radius:0px;padding:15px;">
								<span style="font-size:13px;">Login with Linkedin</span>
							</a>
						</div>
					</div>
				</div>
							
			<div class="create-account" style="margin-top: 20px;background-color: #24404C;" >
		...
		<div class="form-body">
			<h3 class="form-title" style="text-shadow: 0px 1px 1px blue;color: khaki;font-size: 20px;margin-bottom:15px;">Login As</h3>
				<div class="row" style="margin-bottom: 25px;">
					...
					<div class="col-md-10 col-sm-10 col-xs-10">
						<div class="btn-group input-group" data-toggle="buttons" style="box-shadow:0 2px 3px;">
							<label class="" id="loginindividual1" style="margin-bottom:0;">
								<button class="btn btn-default button-responsive" type="button" style="border-right:0;color: #CACCC9;border-radius: 2px 0px 0px 2px;background-color: #577C8C;border:0;">
									<i class="fa fa-user" style="color: #CACCC9;"></i>&nbsp;Individual
								</button>
							 </label>
							 <label class="" id="logincorporate2" style="margin-bottom:0;">
							 	<button class="btn btn-default active button-responsive" type="button" style="border-radius: 0px 2px 2px 0px;color: white;background-color: #45B69C;border:0;">
            ...
            <div class="form-actions" style="border-bottom: 0 !important; padding: 0px 30px 0px 30px !important;">
                <button id="corporate-login-btn" type="submit" class="btn btn-primary btn-block uppercase" style="background-color:#C76B6B !important;box-shadow: 0px 1px 4px #2D2C2C;border-radius:2px;">
                    Login
                </button>
            </div>                                        
            <div class="form-actions" style="margin-top: 14px;border-bottom: 0px;">                                                             
                <div class="form-group" style="margin-left: -4px; margin-bottom: -25px;">
                    <div class="input-group">
                        <label style="font-size: 13px;">
                        <input type="checkbox" name="remember">Remember Me</label>
                    </div>
                </div>
                <a href="javascript:;" id="forget-password-corp" class="forget-password" style="font-size: 14px;text-decoration: initial;color: #D2D6DA !important;">Forgot Password ?
				</a>
            </div>										
				
			<div class="create-account" style="margin-top: 20px;background-color: #75ACC3;">
				<p style="color:black;">
	...
	<form class="register-form" id="individual-register" action="{{ url('/individual/store') }}" method="post" id="individual-register">
		...
		<div class="login-option" >
			<h3 class="form-title" style="text-shadow: 0px 1px 1px blue;color: khaki;font-size: 20px;margin-bottom: 15px;">
				Sign Up As
			</h3>
		</div>
		<div class="row" style="margin-bottom: 25px;">
			...
			<div class="col-md-10 col-sm-10 col-xs-10">
				<div class="btn-group input-group" data-toggle="buttons" style="box-shadow:0 2px 3px;">
					<label class="" id="corpor" style="margin-bottom:0;">
						<button class="btn btn-default active button-responsive" type="button" style="border:0;border-radius: 2px 0px 0px 2px;color: white;background-color: #45B69C;">
							<i class="fa fa-user" style="color: white;"></i>&nbsp;Individual
						</button>
					 </label>
					 <label class="" id="corporate1" style="margin-bottom:0;">
					 	<button class="btn btn-default button-responsive" type="button" style="border:0;border-left:0;border-radius: 0px 2px 2px 0px;color: #CACCC9;background-color: #577C8C;">
							<i class="fa fa-university" style="color: #CACCC9;"></i>&nbsp;Corporate
						</button>
					 </label>
				</div>
		...
		<div style="text-align: center; margin-bottom: 5px;">
			<small style="font-size:14px;color: azure;">One click register using</small>
		</div>
		<div class="login-options" >
			<div class="row social">
		...
		<div style="text-align: center; margin-bottom: 5px;">
			<small style="font-size:12px;color: azure;">We don't post and disclose any information.</small>
		</div>
		<h2 class="decorated" style="margin: 0px 10px 8px 10px;color: #D0D0D0;">
			<span style="font-size: 12px;">OR</span>
		</h2>
		...
		<div class="form-group margin-top-20 margin-bottom-20">
			<label style="font-size: 13px;color: #D2C9C9 !important;">
				...
				<a href="javascript:;" style="color: #1010FF;">Terms of Service </a>& <a href="javascript:;" style="color: #1010FF;">Privacy Policy </a>
			</label>
	...
	<form class="register-corporate-form" action="{{ url('/corporate/store') }}" method="post" id="corporate-register">
		...
		<div class="row" style="margin-bottom: 25px;">
			...
			<div class="col-md-10 col-sm-10 col-xs-10">
				<div class="btn-group input-group" data-toggle="buttons" style="box-shadow:0 2px 3px;">
					<label class="" id="individual2" style="margin-bottom:0;">
						<button class="btn btn-default button-responsive" type="button" style="border:0;border-right:0;color: #CACCC9;border-radius: 2px 0px 0px 2px;background-color: #577C8C;">
							<i class="fa fa-user" style="color: #CACCC9;"></i>&nbsp;Individual
						</button>
					 </label>
					 <label class="" id="individual3" style="margin-bottom:0;">
					 	<button class="btn btn-default active button-responsive" type="button" style="border:0;border-radius: 0px 2px 2px 0px;color: white;background-color: #45B69C;">
							<i class="fa fa-university" style="color: white;"></i>&nbsp;Corporate
						</button>
					 </label>
				</div>
